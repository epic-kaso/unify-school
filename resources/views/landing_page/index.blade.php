...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">{{ $school->name or 'Unify Schools'}}</a>
        </div>
        ...
        <div class="intro-text">
            ...
            @if(isset($school))
                <a class="btn btn-xl btn-info" href="{{ $school->student_website }}"
                   style="background-color: #fec503;border-color: #fec503">Students Login</a>
...
@if(!isset($school))
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/roundicons.png') }}" class="img-responsive"
                             alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/startup-framework.png') }}"
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/treehouse.png') }}" class="img-responsive"
                             alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/golden.png') }}" class="img-responsive" alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/escape.png') }}" class="img-responsive" alt="">
                    </a>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="{{ asset('landing_page/img/portfolio/dreams.png') }}" class="img-responsive" alt="">
                    </a>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('landing_page/img/about/1.jpg') }}"
                                     alt="">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('landing_page/img/about/2.jpg') }}"
                                     alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('landing_page/img/about/3.jpg') }}"
                                     alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('landing_page/img/about/4.jpg') }}"
                                     alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="{{ asset('landing_page/img/team/1.jpg') }}" class="img-responsive img-circle" alt="">
                        <h4>Kay Garland</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="{{ asset('landing_page/img/team/2.jpg') }}" class="img-responsive img-circle" alt="">
                        <h4>Larry Parker</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="{{ asset('landing_page/img/team/3.jpg') }}" class="img-responsive img-circle" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="{{ asset('landing_page/img/logos/envato.jpg') }}" class="img-responsive img-centered"
                             alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="{{ asset('landing_page/img/logos/designmodo.jpg') }}"
                             class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="{{ asset('landing_page/img/logos/themeforest.jpg') }}"
                             class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="{{ asset('landing_page/img/logos/creative-market.jpg') }}"
                             class="img-responsive img-centered" alt="">
                    </a>
                </div>
            </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <img class="img-responsive"
                                 src="{{ asset('landing_page/img/portfolio/roundicons-free.png') }}" alt="">
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <img class="img-responsive img-centered"
                                 src="{{ asset('landing_page/img/portfolio/startup-framework-preview.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered"
                                 src="{{ asset('landing_page/img/portfolio/treehouse-preview.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered"
                                 src="{{ asset('landing_page/img/portfolio/golden-preview.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered"
                                 src="{{ asset('landing_page/img/portfolio/escape-preview.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered"
                                 src="{{ asset('landing_page/img/portfolio/dreams-preview.png') }}" alt="">
    ...
    <!-- jQuery -->
    <script src="{{ asset('landing_page/js/jquery.js') }}"></script>
    ...
    <script src="{{ asset('landing_page/js/classie.js') }}"></script>
    <script src="{{ asset('landing_page/js/cbpAnimatedHeader.js') }}"></script>

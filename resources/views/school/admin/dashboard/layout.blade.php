...
<body data-ng-class="{ 'layout-fixed' : app.layout.isFixed, 'aside-collapsed' : false, 'layout-boxed' : app.layout.isBoxed, 'layout-fs': app.useFullLayout, 'hidden-footer': app.hiddenFooter, 'layout-h': app.layout.horizontal, 'aside-float': app.layout.isFloat}">

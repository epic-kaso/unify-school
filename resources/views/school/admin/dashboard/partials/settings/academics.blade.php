        ...
        <tabset justified="false" type="pills">
                        ...
                        <div class="row">
                            ...
                            <div id="rowinfo">
                                <accordion>
                                    ...
                                    <accordion-group ng-if="!gradingSystems.data || gradingSystems.data.length < 1">
                                        <accordion-heading>
                        ...
                        <div class="row">
                            ...
                            <div id="rowinfo">
                                <accordion>
                                    ...
                                    <accordion-group ng-if="!gradeAssessmentSystems.data || gradeAssessmentSystems.data.length < 1">
                                        <accordion-heading>
            ...
            <tab>
                ...
                <div style="margin-top: 20px">
                    ...
                    <accordion>
                        <accordion-group ng-if="behaviourSkillSystems.loading">
                            <accordion-heading>
                                <span class="fa fa-spin fa-spinner"></span> Loading..
                            </accordion-heading>
                        </accordion-group>

                        <accordion-group ng-if="!behaviourSkillSystems.data || behaviourSkillSystems.data.length < 1">
                            <accordion-heading>
                                <span class="fa fa-question-circle"></span> No Behaviour Assessment System Added yet
                            </accordion-heading>
                        </accordion-group>

                        <accordion-group ng-repeat="behaviourSkillSystem in behaviourSkillSystems.data" is-open="behaviourSkillSystem.accordionState">
                            <accordion-heading>
                                            <span class="display_box" ng-hide="behaviourSkillSystem.edit">
                                                <span class="fa"
                                                      ng-class="{
                                                      'fa-minus': behaviourSkillSystem.accordionState,
                                                      'fa-plus': !behaviourSkillSystem.accordionState
                                                      }" ng-attr-tooltip="@{{ behaviourSkillSystem.accordionState ? 'Click to close' : 'Click to Expand' }}">
                                                </span>
                                                @{{ behaviourSkillSystem.name }}
                                                <button class="btn btn-default btn-xs"
                                                        ng-click="setBehaviourSkillSystemEditMode($event,behaviourSkillSystem,true)">
                                                    Rename
                                                </button>
                                            </span>
                                            <span class="edit-box" style="display: inline-block;width: 320px;"
                                                  ng-show="behaviourSkillSystem.edit">
                                                <input style="width: 250px;display: inline-block" type="text"
                                                       ng-model="behaviourSkillSystem.name"
                                                       ng-click="preventDefaultAction($event)"
                                                       class="form-control"/>
                                                <span class="btn btn-default"
                                                      style="width: 60px"
                                                      ng-click="setBehaviourSkillSystemEditMode($event,behaviourSkillSystem,false)">Save</span>
                                            </span>
                                            <span class="pull-right" ng-show="behaviourSkillSystem.deleting">
                                                <span class="fa fa-spin fa-spinner"></span> Deleting..
                                            </span>
                                            <span class="pull-right"
                                                  ng-show="!behaviourSkillSystem.deleting"
                                                  ng-click="behaviourSkillSystem.deleting = true;
                                                            deleteBehaviourSkillSystem($event,behaviourSkillSystems.data,$index)">
                                                <i class="fa fa-times"></i>
                                            </span>
                            </accordion-heading>
                            <div class="row">
                                ...
                                <div class="col-sm-12" ng-if="cognitive_assessment == 'behaviour'">
                                                ...
                                                <div class="input-group">
                                                    <input ng-disabled="behaviour.adding" id="domain" class="form-control" type="text"
                                                         ...
                                                         <span class="input-group-btn">
                                                              <button ng-show="!behaviour.adding" class="btn btn-primary" ng-click="addBehaviour(behaviour,behaviourSkillSystem)">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <ul class="list-group">
                                                <li class="list-group-item" ng-repeat="item in behaviourSkillSystem.behaviours">
                                                    <div>
                                                        <span class="pull-right">
                                                            <button ng-show="!item.removing" class="btn btn-xs btn-danger" ng-click="removeBehaviour(item,behaviourSkillSystem)"><span class="fa fa-times"></span></button>
                                ...
                                <div class="col-sm-12" ng-if="cognitive_assessment == 'skill'">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input ng-disabled="skill.adding" id="domain" class="form-control" type="text"
                                                         ...
                                                         <span class="input-group-btn">
                                                             <button ng-hide="skill.adding" class="btn btn-primary" ng-click="addSkill(skill,behaviourSkillSystem)">
                                                                 <i class="fa fa-plus"></i> Add
                                                             </button>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <ul class="list-group">
                                                <li class="list-group-item" ng-repeat="item in behaviourSkillSystem.skills">
                                                    <div>
                                                        <span class="pull-right">
                                                            <button ng-show="!item.removing" class="btn btn-xs btn-danger" ng-click="removeSkill(item,behaviourSkillSystem)">
                        ...
                        <div>
                            <span ng-show="behaviourSkillSystems.isAddingNewBehaviourSkillSystem"> 
                                    <span class="fa fa-spin fa-spinner"></span> Adding New Behaviour Assessment System..
                            </span>
                        </div>
                        <div>
                            <button ng-hide="behaviourSkillSystems.isAddingNewBehaviourSkillSystem" class="btn btn-primary" 
                                    ng-click="addNewBehaviourSkillSystem()"
                                    >
                                Add New Behaviour Assessment System
                            </button>
                        </div>
                        
                        <div class="" style="margin-top: 50px">
                            <h4>Assign Behaviour Assessment Systems</h4>
                            <hr/>
                            <div class="row" ng-init="showAdvanced = false;">
                                <div class="col-sm-4" ng-repeat="schoolCategory in schoolCategories">
                                    <div class="form-group">
                                        <label>@{{ schoolCategory.display_name }}</label>
                                        <select class="form-control" required
                                                ng-disabled="behaviourSkillSystems.loading"
                                                ng-change="saveAssignedBehaviourSkillSystem(assignedBehaviourSkillSystem)"
                                                ng-model="assignedBehaviourSkillSystem[schoolCategory.name]"
                                                ng-options="system.id as system.name for system in behaviourSkillSystems.data">
                                            <option value="">Select Behavioural System</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="advanced_config" ng-show="showAdvanced" >
                                        <div class="form-group" ng-repeat="classItem in schoolCategory.classes">
                                            ...
                                            <select class="form-control" required
                                                    ng-change="saveBehaviourSkillSystemAssignment(classItem)"
                                                    ng-disabled="classItem.loading"
                                                    ng-model="classItem.scoped_behaviour_skill_system_id"
                                                    ng-options="system.id as system.name for system in behaviourSkillSystems.data">
                                                <option value="">Select Behavioural System</option>
                                            </select>
                                        </div>

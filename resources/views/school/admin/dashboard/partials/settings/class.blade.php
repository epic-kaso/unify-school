<div class="panel">
    ...
    <div class="panel-body">
        <tabset justified="false" type="pills">
            <tab>
                <tab-heading>
                    <em class="icon-equalizer fa-sm"></em> Manage School Categories
                </tab-heading>
                <div class="row">
                    ...
                    <div class="form-group">
                        <div>
                            <ul class="list-group">
                                <li ng-repeat="school_category in config.school.school_types[config.school.selected_school_type - 1].school_categories"
                                        class="list-group-item">
                                    <span class="school_category_title">@{{ school_category.display_name }}</span>
                    <span class="btn btn-xs btn-danger pull-right">Remove</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <tab>
                <tab-heading>
                    <em class="fa-gear fa-sm"></em> Manage Classes
                </tab-heading>
                <div>
                    <div class="form-group"

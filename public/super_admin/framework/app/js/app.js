...
App.constant('AssetsBaseURL', '/super_admin/framework');
...
App.config(['$stateProvider', '$locationProvider', '$urlRouterProvider', 'RouteHelpersProvider', 'ViewBaseURL',
    ...
    $translateProvider.useStaticFilesLoader({
        prefix: '/super_admin/framework/app/i18n/',
        suffix: '.json'
    });
...
App
    ...
    .constant('APP_REQUIRES', {
        ...
        scripts: {
            'modernizr': ['/super_admin/framework/vendor/modernizr/modernizr.js'],
            'icons': ['/super_admin/framework/vendor/fontawesome/css/font-awesome.min.css',
                '/super_admin/framework/vendor/simple-line-icons/css/simple-line-icons.css']
        },
...
App.provider('RouteHelpers', ['APP_REQUIRES', function (appRequires) {
    ...
    this.basepath = function (uri) {
        return '/super_admin/framework/app/views/' + uri;
    };
